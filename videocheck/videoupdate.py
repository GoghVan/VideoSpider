...
class VideoUpdate(object):
    ...
    def rr_update(self):
        ...
        flags = check_url(self.web_url, video_message, self.file_name, self.connect, video_url)
    ...
    def fh_update(self):
        ...
        flags = check_url(self.web_url, video_message, self.file_name, self.connect, " ")
