...
def update_message(check, connect, web_url, video_message):
    ...
    if (point == 1 or point == 2 or point == 3 or point == 4 or point == 5) \
        ...
        try:
            ...
            print ('videocheck.messupdate.update_message.video_view(92): ' + str(e))
            conn.rollback()
        if point == 1:
    ...
    if (point == 2 or point == 3 or point == 4) and check[1].encode('utf8') != str(video_message[7]):
        try:
            ...
            print ('videocheck.messupdate.update_message.video_oppose(114): ' + str(e))
            conn.rollback()
    ...
    if (point == 1 or point == 2 or point == 3 or point == 4) \
        ...
        try:
            ...
            print ('videocheck.messupdate.update_message.video_support(137): ' + str(e))
            conn.rollback()
        if point == 1:
    ...
    if (point == 1 or point == 2 or point == 3) \
        ...
        try:
            ...
            print ('videocheck.messupdate.update_message.video_comment(164): ' + str(e))
            conn.rollback()
        if point == 1:
    ...
    if point == 2 and check[4].encode('utf8') != str(video_message[10]):
        try:
            ...
            print ('videocheck.messupdate.update_message.video_comment_fav(186): ' + str(e))
            conn.rollback()
    ...
    if point == 2 and check[5].encode('utf8') != str(video_message[11]):
        try:
            ...
            print ('videocheck.messupdate.update_message.video_comment_against(204): ' + str(e))
            conn.rollback()
