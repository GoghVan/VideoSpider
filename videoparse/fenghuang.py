...
class FengHuang(object):
    ...
    def fh_message(self, web_url):
        try:
            ...
            # 构造请求视频原地址url
            req_url = 'http://tv.ifeng.com/h6/' + video_id + \
                      '/video.json?callback=callback&msg=' + video_id + '&rt=js'
            # 获取data数据(str)
            ...
            try:
                ...
                video_comment = '0'
                print ('videoparse.fenghuang.fh_message.video_comment(98): ' + str(e))
            # 获取视频path(str)
            ...
            print ('videoparse.fenghuang.fh_message(112): ' + str(e))
