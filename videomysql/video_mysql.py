...
class VideoMysql(object):
    ...
    def sh_mysql(self):
        ...
        try:
            ...
            print ('videomysql.souhu.sh_mysql(37): ' + str(e))
            conn.rollback()
        cur.close()
    ...
    def mg_mysql(self):
        ...
        try:
            ...
            print ('videomysql.mangotv.mg_mysql(61): ' + str(e))
            conn.rollback()
        cur.close()
    ...
    def fh_mysql(self):
        ...
        try:
            ...
            print ('videomysql.fenghuang.fh_mysql(81): ' + str(e))
            conn.rollback()
        cur.close()
    ...
    def wy_mysql(self):
        ...
        try:
            ...
            print ('videomysql.wangyi.wy_mysql(104): ' + str(e))
            conn.rollback()
        cur.close()
    ...
    def rr_mysql(self):
        ...
        try:
            ...
            print ('videomysql.renren.rr_mysql(123): ' + str(e))
            conn.rollback()
        cur.close()
