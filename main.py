...
if __name__ == '__main__':
    ...
    # 搜狐视频
    # urls5 = ('http://my.tv.sohu.com/pl/9431111/95471920.shtml', 'http://my.tv.sohu.com/pl/9431111/95472081.shtml',
    #          'https://my.tv.sohu.com/us/202732077/94652485.shtml', 'https://tv.sohu.com/20171115/n600254361.shtml',
             # 'http://my.tv.sohu.com/pl/9059869/94684875.shtml', 'http://my.tv.sohu.com/pl/9059869/94586313.shtml',
             # 'http://my.tv.sohu.com/pl/9336861/94727839.shtml', 'http://my.tv.sohu.com/pl/9413585/94439505.shtml',
             # 'http://my.tv.sohu.com/pl/8357409/95473152.shtml', 'http://my.tv.sohu.com/pl/9431111/95471920.shtml',
    ...
    startTime = datetime.datetime(2017, 12, 30, 0, 0, 0)
    while datetime.datetime.now() < startTime:
        ...
        # 网易视频
        # for url in urls2:
        #     VideoUpdate(url).wy_update()
        # 凤凰视频
        for url in urls3:
            VideoUpdate(url).fh_update()
        # 芒果TV
        # for url in url4:
        #     VideoUpdate(url).mg_update()
        # 搜狐视频
        # for url in urls5:
        ...
        # q = manager.Queue()
        # p = Pool()
        # p1 = p.apply_async(VideoUpdate(url).rr_update())
        # p2 = p.apply_async(VideoUpdate(url).wy_update())
        # p3 = p.apply_async(VideoUpdate(url).fh_update())
        # p4 = p.apply_async(VideoUpdate(url).mg_update())
        # p5 = p.apply_async(VideoUpdate(url).sh_update())
        # p.close()
        # p.join()
